...
(function() {
  ...
  webjs = require('sockjs/lib/webjs');

  utils = require('sockjs/lib/utils');

  trans_websocket = require('sockjs/lib/trans-websocket');

  trans_jsonp = require('sockjs/lib/trans-jsonp');

  trans_xhr = require('sockjs/lib/trans-xhr');

  iframe = require('sockjs/lib/iframe');

  trans_eventsource = require('sockjs/lib/trans-eventsource');

  trans_htmlfile = require('sockjs/lib/trans-htmlfile');

  chunking_test = require('sockjs/lib/chunking-test');
